...
import { clearSelectedProduct, createProductAsync, fetchProductsByIdAsync, selectBrands, selectCategories, selectProductById, updateProductAsync } from '../../product-list/productSlice';
            ...
            <form noValidate
                ...
                <div className="space-y-12 bg-white p-10">
                    <div className="border-b border-gray-900/10 pb-12">
                        {params.id ? <h2 className="text-base font-semibold leading-7 text-gray-900">Edit product</h2> : <h2 className="text-base font-semibold leading-7 text-gray-900">Add product</h2>}
                                    ...
                                    <div className="flex px-2 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                                        <input
                                            ...
                                            {...register('discountPercentage', {
                                                required: "Discount percentage on the product is required",
                                                min: 0,
                                                max: 100
                                            })}
                                ...
                                <div className="mt-2">
                                    <div className="flex px-2 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                                        <input
                                            type="text"
                                            {...register('thumbnail', {
                                                required: "Thumbnail of the product is required"
                                            })}
                                            id="thumbnail"
                                            className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        />
                                ...
                                <div className="mt-2">
                                    <div className="flex px-2 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                                        <input
                                            type="text"
                                            {...register('image1', {
                                                required: "Image of the product is required"
                                            })}
                                            id="image1"
                                            className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        />
